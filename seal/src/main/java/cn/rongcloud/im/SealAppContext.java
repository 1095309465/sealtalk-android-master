...
import cn.rongcloud.im.utils.MD5Utils;
...
import cn.rongcloud.im.utils.googleApi.TransGoogleUtil;
...
public class SealAppContext implements RongIM.ConversationListBehaviorListener,
    ...
    public boolean onConversationPortraitClick(Context context, Conversation.ConversationType conversationType, String s) {
        Log.e("123","SealAppContext——onConversationPortraitClick");
        return false;
    }

    @Override
    public boolean onConversationPortraitLongClick(Context context, Conversation.ConversationType conversationType, String s) {
        Log.e("123","SealAppContext——onConversationPortraitLongClick");
        return false;
    }

    @Override
    public boolean onConversationLongClick(Context context, View view, UIConversation uiConversation) {
        Log.e("123","SealAppContext——onConversationLongClick");
        return false;
    }
    ...
    public boolean onReceived(Message message, int i) {
      ...
      /*  if (messageContent instanceof TextMessage) {
            TextMessage msg = (TextMessage) messageContent;
            String str = msg.getContent();
          *//*  TransGoogleUtil util = new TransGoogleUtil(str);
            String transLateInfo = util.startGoogleTranslate();*//*
            String transLateInfo=TranslateUtil.baidufanyi(str);
            Log.e("123", "transLateInfo翻譯=" + transLateInfo);
            msg.setContent(transLateInfo);
        }*/
